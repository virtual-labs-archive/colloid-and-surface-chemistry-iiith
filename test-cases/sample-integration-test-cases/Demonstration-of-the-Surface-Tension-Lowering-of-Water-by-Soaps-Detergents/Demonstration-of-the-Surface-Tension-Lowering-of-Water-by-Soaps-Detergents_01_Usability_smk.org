...
* Pre conditions
  ...
  2. Click on IIIT Hyderabad and a list of labs will be displayed on
     the screen.
  3. Select "Colloid and Surface Chemistry" Lab, it will redirect to the Home
     page where a list of experiments will be displayed on the screen.
  4. Click on "Demonstration of the Surface Tension Lowering of Water by Soaps/Detergents" experiment.
