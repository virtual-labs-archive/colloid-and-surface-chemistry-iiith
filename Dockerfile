...
RUN apt-get install -y make php5 apache2 net-tools rsync

RUN mkdir /colloid-and-surface-chemistry-iiith

COPY src/ /colloid-and-surface-chemistry-iiith/src

WORKDIR ./colloid-and-surface-chemistry-iiith/src
